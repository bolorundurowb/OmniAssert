...
public class TimeOnlyAssertionTests
{
    ...
    {
        (new TimeOnly(10, 30, 0)).Must().Be(new TimeOnly(10, 30, 0));
    }
    ...
    public void ToBe_WhenTimesDiffer_ShouldThrow()
    {
        Xunit.Assert.Throws<OmniAssertionException>(() =>
            (new TimeOnly(10, 30, 0)).Must().Be(new TimeOnly(10, 31, 0)));
    }

    [Fact]
    public void ToBeBefore_WhenEarlier_ShouldSucceed()
    {
        (new TimeOnly(10, 30, 0)).Must().BeBefore(new TimeOnly(10, 31, 0));
    }
    ...
    {
        Xunit.Assert.Throws<OmniAssertionException>(() =>
            (new TimeOnly(10, 30, 0)).Must().BeBefore(new TimeOnly(10, 30, 0)));
    }

    [Fact]
    public void ToBeAfter_WhenLater_ShouldSucceed()
    {
        (new TimeOnly(10, 31, 0)).Must().BeAfter(new TimeOnly(10, 30, 0));
    }
    ...
    {
        Xunit.Assert.Throws<OmniAssertionException>(() =>
            (new TimeOnly(10, 30, 0)).Must().BeAfter(new TimeOnly(10, 30, 0)));
    }
}
