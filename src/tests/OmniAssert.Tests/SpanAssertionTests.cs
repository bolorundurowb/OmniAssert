...
public class SpanAssertionTests
{
    ...
    {
        new int[] { 1, 2, 3 }.AsSpan().Verify().ToEqual(new int[] { 1, 2, 3 }.AsSpan());
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2, 3 }.AsSpan().Verify().ToEqual(new int[] { 1, 2, 4 }.AsSpan()); }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2, 3 }.AsSpan().Verify().ToEqual(new int[] { 1, 2 }.AsSpan()); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        new ReadOnlyMemory<byte>(new byte[] { 0x01, 0x02, 0x03 }).Verify()
    ...
    {
        new int[] { 1, 2, 3 }.AsSpan().Verify().NotToEqual(new int[] { 4, 5, 6 }.AsSpan());
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2, 3 }.AsSpan().Verify().NotToEqual(new int[] { 1, 2, 3 }.AsSpan()); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        Array.Empty<int>().AsSpan().Verify().ToBeEmpty();
    }
    ...
    {
        var threw = false;
        try { new int[] { 1 }.AsSpan().Verify().ToBeEmpty(); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        new int[] { 1, 2 }.AsSpan().Verify().NotToBeEmpty();
    }
    ...
    {
        var threw = false;
        try { Array.Empty<int>().AsSpan().Verify().NotToBeEmpty(); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        new int[] { 1, 2, 3 }.AsSpan().Verify().ToContain(2);
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2, 3 }.AsSpan().Verify().ToContain(9); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        new int[] { 1, 2, 3 }.AsSpan().Verify().NotToContain(9);
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2, 3 }.AsSpan().Verify().NotToContain(2); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        new int[] { 1, 2, 3, 4, 5 }.AsSpan().Verify().ToStartWith(new int[] { 1, 2, 3 }.AsSpan());
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2, 3, 4, 5 }.AsSpan().Verify().ToStartWith(new int[] { 2, 3 }.AsSpan()); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2 }.AsSpan().Verify().ToStartWith(new int[] { 1, 2, 3, 4 }.AsSpan()); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        new int[] { 1, 2, 3, 4, 5 }.AsSpan().Verify().ToEndWith(new int[] { 3, 4, 5 }.AsSpan());
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2, 3, 4, 5 }.AsSpan().Verify().ToEndWith(new int[] { 1, 2 }.AsSpan()); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
    ...
    {
        var threw = false;
        try { new int[] { 1, 2 }.AsSpan().Verify().ToEndWith(new int[] { 0, 1, 2, 3 }.AsSpan()); }
        catch (OmniAssertionException) { threw = true; }
        Xunit.Assert.True(threw);
    }
