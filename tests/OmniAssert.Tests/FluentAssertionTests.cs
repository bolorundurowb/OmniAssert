...
public class FluentAssertionTests
{
    ...
    [Fact]
    public void Verify_String_WhenMatching_ShouldSucceedForToBeAndToContain()
    {
    ...
    [Fact]
    public void Verify_StringToBeEmpty_WhenNotEmpty_ShouldThrowOmniAssertionException()
    {
    ...
    [Fact]
    public void VerifyBool_WhenTrueOrFalse_ShouldSucceedForToBeTrueAndToBeFalse()
    {
